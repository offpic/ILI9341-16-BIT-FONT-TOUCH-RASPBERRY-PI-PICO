...
class ILI9341:
    ...
    def init(self):
        ...
        time.sleep_ms(20)
        self.ILI9341_WriteCommand(0xCB)
        self.ILI9341_WriteData(0x39)
        self.ILI9341_WriteData(0x2C)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x34)
        self.ILI9341_WriteData(0x02)
        self.ILI9341_WriteCommand(0xCF)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0xC1)
        self.ILI9341_WriteData(0x30)        
        self.ILI9341_WriteCommand(0xE8)
        self.ILI9341_WriteData(0x85)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x78)
        self.ILI9341_WriteCommand(0x00EA)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteCommand(0xED)
        self.ILI9341_WriteData(0x04)
        self.ILI9341_WriteData(0x03)
        self.ILI9341_WriteData(0x12)
        self.ILI9341_WriteData(0x81)
        self.ILI9341_WriteCommand(0xF7)
        self.ILI9341_WriteData(0x20)
        self.ILI9341_WriteCommand(0xC0)
        self.ILI9341_WriteData(0x23)
        self.ILI9341_WriteCommand(0xC1)
        self.ILI9341_WriteData(0x10)
        self.ILI9341_WriteCommand(0xC5)
        self.ILI9341_WriteData(0x3E)
        self.ILI9341_WriteData(0x28)
        self.ILI9341_WriteCommand(0xC7)
        self.ILI9341_WriteData(0x86)
        ...
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x18)
        self.ILI9341_WriteCommand(0xB6)
        self.ILI9341_WriteData(0x08)
        self.ILI9341_WriteData(0x82)
        self.ILI9341_WriteData(0x27)
        self.ILI9341_WriteCommand(0xF2)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteCommand(0x26)
        self.ILI9341_WriteData(0x01)
        self.ILI9341_WriteCommand(0xE0)
        self.ILI9341_WriteData(0x0F)
        self.ILI9341_WriteData(0x31)
        self.ILI9341_WriteData(0x2B)
        self.ILI9341_WriteData(0x0C)
        self.ILI9341_WriteData(0x0E)
        self.ILI9341_WriteData(0x08)
        self.ILI9341_WriteData(0x4E)
        self.ILI9341_WriteData(0xF1)
        self.ILI9341_WriteData(0x37)
        self.ILI9341_WriteData(0x07)
        self.ILI9341_WriteData(0x10)
        self.ILI9341_WriteData(0x03)
        self.ILI9341_WriteData(0x0E)
        self.ILI9341_WriteData(0x09)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteCommand(0xE1)
        self.ILI9341_WriteData(0x00)
        self.ILI9341_WriteData(0x0E)
        self.ILI9341_WriteData(0x14)
        self.ILI9341_WriteData(0x03)
